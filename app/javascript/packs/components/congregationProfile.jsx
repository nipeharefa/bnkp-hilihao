...
// import all partial
const BasicDisplay = asyncComponent(() => System.import('packs/components/_congregation/BasicDisplay').then(module => module.default));
const NotCreatedBaptis = asyncComponent(() => System.import('packs/components/_congregation/NotCreatedBaptism').then(module => module.default));
const Baptism = asyncComponent(() => System.import('packs/components/_congregation/Baptis').then(module => module.default));

class CongregationProfile extends Component {
  constructor(props) {
    super(props);
    console.log(this);
  }
    ...
    return (
      <div>
        <Row gutter={8}>
          ...
          <Col span={8}>
            <BasicDisplay keyProfile="Tanggal Baptis" valueProfile={congregation.baptism.baptism_at} />
            <BasicDisplay keyProfile="Tanggal Sidi" valueProfile={null} />
          </Col>
          <Col span={8}>
            <BasicDisplay keyProfile="Pelayanan Terakhir" valueProfile={null} />
          </Col>
        </Row>
        {/* <Row gutter={8}>
